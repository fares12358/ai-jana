...
export default function VideosPage() {
  return (
    <div className="max-w-[1400px] mx-auto">
      <h1 className="text-[26px] font-black tracking-tight text-slate-900 dark:text-white mb-1">Videos</h1>
      <p className="text-[14px] text-slate-500 dark:text-slate-400 mb-8">Manage lecture video library</p>
      <div className="flex flex-col items-center justify-center py-28 bg-white dark:bg-[#0f1117] border border-slate-200 dark:border-white/8 rounded-2xl text-slate-400 dark:text-slate-500 gap-3">
        ...
        <p className="text-[14px] font-semibold">Videos — coming soon</p>
